 ...
 * @author levan
 */
public class JFTelaInicial2 extends javax.swing.JFrame {

    /**
     * Creates new form JFTelaInicial
     */
    public JFTelaInicial2() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnAddFornecedor);
        ...
        getContentPane().add(btnVisualizarEstoque);
        ...
        getContentPane().add(btnMenuFuncionario);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFTelaInicial2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFTelaInicial2().setVisible(true);
            }
        });
    }
